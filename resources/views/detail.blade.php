			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					<div class="p-30 mb-30 card-view">
						<img src="{{ asset('assets/images/slider-8-1200x600.jpg') }}" alt="">
					...
					<div class="p-30 mb-30 card-view">
						...
						<div class="row">
							<div class="col-sm-4 mb-sm-20">
								<img src="{{ asset('assets/images/slider-7-400x400.jpg') }}" alt="">
							...
							<div class="col-sm-4 mb-sm-20">
								<img src="{{ asset('assets/images/slider-6-400x400.jpg') }}" alt="">

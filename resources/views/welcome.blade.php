            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="mb-30 sided-250x card-view">
                        <div class="s-left">
                            <img src="{{ asset('assets/images/news-2-250x250.jpg') }}" alt="">
                        </div><!-- left-area -->
                    ...
                    <div class="mb-30 sided-250x card-view">
                        <div class="s-left">
                            <img src="{{ asset('assets/images/news-3-250x250.jpg') }}" alt="">
                        </div><!-- left-area -->
                    ...
                    <div class="mb-30 sided-250x card-view">
                        <div class="s-left">
                            <img src="{{ asset('assets/images/news-4-250x250.jpg') }}" alt="">
                        </div><!-- left-area -->
                        <div class="s-right ptb-50 plr-sm-20 pt-sm-20 pb-sm-5 plr-30 plr-xs-0">
                    ...
                    <div class="mb-30 sided-250x card-view">
                        <div class="s-left">
                            <img src="{{ asset('assets/images/news-5-250x250.jpg') }}" alt="">
                        </div><!-- left-area -->
                        <div class="s-right ptb-50 plr-sm-20 pt-sm-20 pb-sm-5 plr-30 plr-xs-0">
                    ...
                    <div class="mb-30 sided-250x card-view">
                        <div class="s-left">
                            <img src="{{ asset('assets/images/news-6-250x250.jpg') }}" alt="">
                        </div><!-- left-area -->
                        <div class="s-right ptb-50 plr-sm-20 pt-sm-20 pb-sm-5 plr-30 plr-xs-0">
                    ...
                    <div class="sided-250x card-view">
                        <div class="s-left">
                            <img src="{{ asset('assets/images/news-7-250x250.jpg') }}" alt="">
                        </div><!-- left-area -->
                        <div class="s-right ptb-50 plr-sm-20 pt-sm-20 pb-sm-5 plr-30 plr-xs-0">
                ...
                <div class="col-md-12 col-lg-4">
                    ...
                    <div class="mb-30 p-30 card-view">
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-1-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-2-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-3-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-4-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-5-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-6-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-7-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-news-8-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                    ...
                    <div class="mb-30 p-30 card-view">
                        <img src="{{ asset('assets/images/sidebar-review-400x300.jpg') }}" alt="">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <a class="hover-grey dplay-block" href="#">
                        <div class="pos-relative"><img src="{{ asset('assets/images/video-1-300x300.jpg') }}" alt="">
                ...
                <div class="col-sm-6 col-md-3">
                    <a class="hover-grey dplay-block" href="#">
                        <div class="pos-relative"><img src="{{ asset('assets/images/video-2-300x300.jpg') }}" alt="">
                            <div class="hover-video"><span class="icon"><i class="ion-play"></i></span></div>
                        </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <a class="hover-grey dplay-block" href="#">
                        <div class="pos-relative"><img src="{{ asset('assets/images/video-3-300x300.jpg') }}" alt="">
                            <div class="hover-video"><span class="icon"><i class="ion-play"></i></span></div>
                        </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <a class="hover-grey dplay-block" href="#">
                        <div class="pos-relative"><img src="{{ asset('assets/images/video-4-300x300.jpg') }}" alt="">
                            <div class="hover-video"><span class="icon"><i class="ion-play"></i></span></div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="p-30 card-view">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <img src="{{ asset('assets/images/sport-1-400x300.jpg') }}" alt="">
                            </div><!-- col-sm-6 -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="p-30 card-view mb-30">
                                ...
                                <img src="{{ asset('assets/images/lifestyle-1-400x300.jpg') }}" alt="">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="p-30 card-view mb-30">
                                ...
                                <img src="{{ asset('assets/images/business-1-400x300.jpg') }}" alt="">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="p-30 card-view mb-30">
                                ...
                                <img src="{{ asset('assets/images/culture-1-400x300.jpg') }}" alt="">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="p-30 card-view mb-30">
                                ...
                                <img src="{{ asset('assets/images/tech-1-400x300.jpg') }}" alt="">
                ...
                <div class="col-md-12 col-lg-4">
                    ...
                    <div class="mb-30 p-30 card-view">
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-most-read-1-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-most-read-2-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-most-read-3-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-most-read-4-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-most-read-5-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-80x mb-20">
                            <div class="s-left">
                                <img src="{{ asset('assets/images/sidebar-most-read-6-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                    ...
                    <div class="mb-30 p-30 card-view">
                        ...
                        <div class="sided-90x mb-20">
                            <div class="s-left br-3 oflow-hidden">
                                <img src="{{ asset('assets/images/sidebar-profile-1-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-90x mb-20">
                            <div class="s-left br-3 oflow-hidden">
                                <img src="{{ asset('assets/images/sidebar-profile-2-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-90x mb-20">
                            <div class="s-left br-3 oflow-hidden">
                                <img src="{{ asset('assets/images/sidebar-profile-3-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                        ...
                        <div class="sided-90x">
                            <div class="s-left br-3 oflow-hidden">
                                <img src="{{ asset('assets/images/sidebar-profile-4-100x100.jpg') }}" alt="">
                            </div><!-- s-left -->
                    ...
                    <div class="mt-30 p-30 plr-40 card-view text-center">
                        ...
                        <img class="mtb-20 max-w-100x mlr-auto" src="{{ asset('assets/images/sidebar-profile-5-100x150.jpg') }}" alt="">
    ...
    <footer class="bg-191 pos-relative color-ccc bg-primary pt-50">
        ...
        <div class="container">
                ...
                <div class="col-lg-4 col-md-8 col-sm-8">    
                    <div class="pl-10 pl-sm-0"> 
                        ...
                        <div class="sided-80x mb-30">
                            <a class="s-left" href="#">
                                <img src="{{ asset('assets/images/video-1-300x300.jpg') }}" alt="">
                        ...
                        <div class="sided-80x mb-30">
                            <a class="s-left" href="#">
                                <img src="{{ asset('assets/images/video-2-300x300.jpg') }}" alt="">
                                <div class="hover-video sm"><span class="icon"><i class="ion-play"></i></span></div>
                            </a><!-- s-left -->
            ...
            <div class="text-center ptb-30">
                <div class="row">
                    <div class="col-sm-3">
                        <a class="mtb-10" href="#"><img src="{{ asset('assets/images/logo-white.png') }}" alt=""></a>
                    </div><!-- col-sm-3 -->
